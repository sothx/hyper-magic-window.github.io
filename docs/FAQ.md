...
## 14. 为什么我的滑动条不能左右调整比例？我的是Mix Fold 系列。

官方不支持，我也没办法 + 2。

## 15. 为什么有时候过渡动画很奇怪，整个窗口旋转了一圈，有时候又会黑一下？
...
## 20.智能助理添加的快递小组件，点击进去淘宝只有右侧界面，而且会卡死，怎么解决？

新版淘宝已经自适配平板，模块不再对淘宝的适配施加任何干预，这个问题是由于淘宝的平板适配缺陷产生的，请多多反馈给淘宝官方去修复。

## 21.为什么哔哩哔哩看直播无法全屏？还有一些应用界面也显示不全？
