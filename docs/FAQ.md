...
模块目前总适配应用数量接近7000+，毫不夸张地说，安装《完美横屏应用计划》之后，您的设备对于平行视界的适配数量将仅次于华为 MatePad 系列，并且我们针对其中高频使用的700+应用手工做了精适配。
...
以下设备经过观察，也可能具备开发单独的《完美横屏应用计划》的可能性，但因开发者本人手上并无该设备或者以下设备ROOT成本较高，故做搁置：

- OPPO Pad 2(仅可扩充平行视界应用数量，不支持强制横屏，且OPPO Pad 2具有相对较高的ROOT成本，故做搁置)
- OnePlus Pad(OPPO Pad 2国际版，不在国内发售，故做搁置)
