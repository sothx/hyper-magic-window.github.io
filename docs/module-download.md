...
### 小米平板安卓17通用版(仅适配Android 17)

模块安装包名称：pad-x.xx.xx.zip

模块简介：适配基于Android 17的Hyper OS for Pad，以及各类基于Android 16的Hyper OS For Pad第三方移植包的机型

### 小米平板安卓16通用版(仅适配Android 16)

模块安装包名称：pad-general-baklava-x.xx.xx.zip

模块简介：适配基于Android 16的Hyper OS for Pad，以及各类基于Android 16的Hyper OS For Pad第三方移植包的机型

### 小米平板安卓15通用版(仅适配Android 15)

模块安装包名称：pad-general-vanillaIceCream-x.xx.xx.zip
...
### 小米折叠屏安卓16通用版(仅小米 Mix Fold 系列)

模块安装包名称：fold-general-mixFold-x.xx.xx.zip

模块简介：适配Android 15-16的小米 Mix Fold 折叠屏系列，针对 Hyper OS For Fold有独立的适配优化，并提供部分系统功能增强。

### 小米折叠屏安卓13-15通用版(仅小米 Mix Fold 系列)

模块安装包名称：fold-general-miuiAutoUI-x.xx.xx.zip
...
模块安装包名称：pad-hyperos3-based-on-vanillaIceCream-x.xx.xx.zip

模块简介：

适配Android 15的Hyper OS 3.0，优化部分应用在应用布局优化2.0下的体验~
...
- [移动云盘下载(首选推荐)](https://yun.139.com/shareweb/#/w/i/2v3EzdcAAyc5b)

- [GitHub Release 下载](https://github.com/sothx/mipad-magic-window/releases/)
  - 小米平板安卓17通用版(pad-x.xx.xx.zip)
  - 小米平板安卓16通用版(pad-general-baklava-x.xx.xx.zip)
  - 小米平板安卓15通用版(pad-general-vanillaIceCream-x.xx.xx.zip)
  ...
  - 小米折叠屏安卓16通用版(fold-general-mixFold-x.xx.xx.zip)
